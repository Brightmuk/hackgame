...
class PasswordCrackerScreen extends StatefulWidget {
  final Tool tool;
  const PasswordCrackerScreen({Key key,this.tool}) : super(key: key);

  @override
  _PasswordCrackerScreenState createState() => _PasswordCrackerScreenState();
}

class _PasswordCrackerScreenState extends State<PasswordCrackerScreen> {
