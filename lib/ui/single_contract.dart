...
class SingleContractScreen extends StatefulWidget {
  const SingleContractScreen({Key key}) : super(key: key);

  @override
  _SingleContractScreenState createState() => _SingleContractScreenState();
}

class _SingleContractScreenState extends State<SingleContractScreen> {
  int currentTab = 0;
